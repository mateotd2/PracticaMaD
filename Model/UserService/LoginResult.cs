...
namespace Es.Udc.DotNet.PracticaMaD.Model.UserService
{
    ...
    public class LoginResult
    {
        ...
        // The GetHashCode method is used in hashing algorithms and data structures such as a hash
        // table. In order to ensure that it works properly, it is based on a field that does not change.
