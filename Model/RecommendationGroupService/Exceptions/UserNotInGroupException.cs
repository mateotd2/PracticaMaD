...
{
    /// <summary>
    /// Public <c>OwnerGroupAbandonException</c> which captures the error with the Id of the group.
    ...
    public class UserNotInGroupException : Exception
    {
        ...
        public UserNotInGroupException(long groupId, string userLogin)
        ...
        /// <summary>
        /// Stores the User login of the exception
        /// </summary>
